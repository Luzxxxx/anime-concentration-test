...
![二次元浓度测试封面](./public/assets/images/og/cover.png)

# 二次元浓度测试

**Anime Concentration Test · ACGN Quiz & Persona**

这是一个从 ACGN 兴趣出发的小项目：用一组横跨番剧、游戏、声优与梗文化的题目，看看你的二次元知识储备究竟有多深。

项目内置 226 道题、三种挑战模式和双计分系统；完成测试后会生成能力画像、角色匹配结果与专属次元通行证。成绩、成就和历史记录均保存在本地，也可以安装为 PWA 离线访问。

[在线体验](https://luzxxxx.github.io/anime-concentration-test/) · [问题反馈](https://github.com/Luzxxxx/anime-concentration-test/issues)
...
```bash
git clone https://github.com/Luzxxxx/anime-concentration-test.git
cd anime-concentration-test
npm install
npm run dev
```
